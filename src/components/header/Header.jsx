      ...
      <div className="container">
        <div className="row header">
          <div className="col-md-3 d-flex">
            <Link to="/">
              <img src={logo} alt="auto-shop logo" className="logo" />
            </Link>
          </div>
          <div className="container col-md-5 m-auto search-box rounded">
            <div className="search-products d-flex">
              <input
                ...
                className="header-search shadow-none"
              />{" "}
              <span className="vertical-line">|</span>
              <Dropdown className="ps-4">
                <Dropdown.Toggle
                  id="dropdown-categories"
                  className="categories-dropdown shadow-none"
                >
                  All Categories
                </Dropdown.Toggle>

                <Dropdown.Menu className="category-dropdown-header">
              ...
              <div>
                <Button
                  variant="danger"
                  className="search-btn ms-4 shadow-none"
                >
